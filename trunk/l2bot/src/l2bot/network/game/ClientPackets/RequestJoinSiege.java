...
public final class RequestJoinSiege extends L2GameClientPacket
{
  ...
  //  private int _isJoining;
   ...
   // //@Override
	protected void readImpl(int id, boolean attacker, boolean joining)
    {
        writeD(id);//_castleId = readD();
        writeD(attacker?1:0);//_isAttacker = readD();
        writeD(joining?1:0);// _isJoining = readD();
    }
/*
    //@Override
