...
public class RequestAquireSkill extends L2GameClientPacket
{
	...
	////@Override
	protected void readImpl(int id, int lvl, int type)
	{
		writeD(id);//_id = readD();
		writeD(lvl);//_level = readD();
		writeD(type);//_skillType = readD();
	}
	...
	protected void runImpl()
	{
        ...
        {
            _log.warning("possible cheater: "+player.getName()+" attempting to learn a skill while he/she is transformed! < Ban him/her!");
