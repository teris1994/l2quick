...
public final class RequestPledgeSetAcademyMaster extends L2GameClientPacket
{
   ...
   /* private String _currPlayerName;
    ...
    //@Override*/
	protected void readImpl(boolean set, String actual, String nuevo)
    {
        writeD(set?1:0);//_set = readD();
        writeS(actual);//_currPlayerName = readS();
        writeS(nuevo);//_targetPlayerName = readS();
    }
