...
public final class RequestConfirmSiegeWaitingList extends L2GameClientPacket
{
    ...
    ////@Override
	protected void RequestConfirmSiegeWaitingList(int castleId, int clanId, boolean approved)
    {
        writeD(castleId);//_castleId = readD();
        writeD(clanId);//_clanId = readD();
        writeD(approved?1:0);//_approved = readD();
    }
/*
    //@Override
