...
public class PartyMatchDetail extends L2GameServerPacket
{
	...
	@Override
	public void readP()  //ni idea de lo que es esto --> solo se logea y ya sta
	{
		//writeC(0x9d);
		...
		System.out.println(readS());//writeS("  " + _activeChar.getPartyMatchingMemo()); // seems to be bugged.. first 2 chars get stripped away 
	}
