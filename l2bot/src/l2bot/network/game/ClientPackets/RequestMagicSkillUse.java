...
public final class RequestMagicSkillUse extends L2GameClientPacket
{
	...
	////@Override
	protected void readImpl(int id, boolean control, boolean shilft)
	{
		writeD(id);//_magicId      = readD();              // Identifier of the used skill
		writeD(control?1:0);//_ctrlPressed  = readD() != 0;         // True if it's a ForceAttack : Ctrl pressed
		writeD(shilft?1:0);//_shiftPressed = readC() != 0;         // True if Shift pressed
	}
