...
public final class Action extends L2GameClientPacket
{
	...
	public void Action(int objectId, int x, int y, int z, boolean Shilft)
	{
		writeD(objectId);   // Target object Identifier
		writeD(x);
		writeD(y);
		writeD(z);                
		writeC((byte) (Shilft ? 0x01 : 0x00));   // Action identifier : 0-Simple click, 1-Shift click
	}
        /*
	//@Override
